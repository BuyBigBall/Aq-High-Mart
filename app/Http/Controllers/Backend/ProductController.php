...
use Intervention\Image\Facades\Image;//Image;
...
class ProductController extends Controller
{
    ...
    public function store(ProductStoreRequest $request)
    {
        ...
        $product = Product::create([
            ...
            'product_slug_bn' => $request->input('product_slug_bn'), # $request->input('product_name_en'),
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->update([
            ...
            'sub_subcategory_id' => $request->input('sub_subcategory_id'),
            'product_name_bn' => $request->input('product_name_bn'),
            'product_slug_bn' => $request->input('product_slug_bn'),    // Str::slug($request->input('product_name_bn')),
            'product_code' => $request->input('product_code'),
            'product_qty' => $request->input('product_qty'),
            'product_tags_bn' => $request->input('product_tags_bn'),
            'product_size_bn' => $request->input('product_size_bn'),
