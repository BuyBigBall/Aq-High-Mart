...
@section('title')
    {{ env('SHOP_NAME') }}  Fashion - Tag Product
@endsection
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ route('frontend-product-details',['id' => $tag_product->id, 'slug' => $tag_product->product_slug_bn]) }}"><img
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="{{ route('frontend-product-details',['id' => $tag_product->id, 'slug' => $tag_product->product_slug_bn]) }}">
                                                        ...
                                                        <div class="product-price">
                                                            @if ($tag_product->discount_price == NULL)
                                                            <span class="price">{{ $tag_product->selling_price }}元</span>
                                                            @else
                                                            <span class="price">{{ $tag_product->discount_price }}元</span>
                                                            <span class="price-before-discount">{{ $tag_product->selling_price }}元</span>
                                                            @endif
                                                        </div>
                                                        <!-- /.product-price -->
