    ...
    <div class="footer-bottom">
        ...
        <div class="row">
            ...
            <div class="module-body">
                ...
                <li class="first"><a href="#" title="联系我们">我的帐户</a></li>
                <li><a href="#" title="关于我们">订单历史</a></li>
                <li><a href="#" title="常问问题">常问问题</a></li>
                <li><a href="#" title="热门搜索">特价商品</a></li>
                <li class="last"><a href="#" title="我的订单在哪里?">帮助中心</a></li>
                </ul>
            </div>
            <!-- /.module-body --> 
            </div>
            ...
            <div class="module-body">
                <ul class='list-unstyled'>
                <li class="first"><a title="Your Account" href="#">关于我们</a></li>
            ...
            <div class="module-body">
                <ul class='list-unstyled'>
                <li class="first"><a href="#" title="关于我们">购物指南</a></li>
                <li><a href="#" title="博客">博客</a></li>
                <li><a href="#" title="公司">公司</a></li>
                <li><a href="#" title="投资者关系">投资者关系</a></li>
                <li class=" last"><a href="contact-us.html" title="供应商">联系咨询信息</a></li>
                </ul>
            </div>
            <!-- /.module-body --> 
            </div>
